	...
	return (
		<div className="px-4 sm:px-12">
			...
			<form method="post" action="/change-password" className="space-y-6">
				<div>
					<label className="block text-sm leading-6 font-medium text-zinc-900">Current Password</label>
					<input type="password" name="currentPassword" required autoFocus className="form-input mt-2 px-3" />
				</div>
				...
				<div>
					...
					<input
						...
						className="form-input mt-2 px-3"
					/>
				</div>

				<div>
					<label className="block text-sm leading-6 font-medium text-zinc-900">Confirm New Password</label>
					<input type="password" name="confirmNewPassword" required className="form-input mt-2 px-3" />
				</div>
