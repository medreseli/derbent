	...
	return (
		<div className="px-4 py-8 text-center sm:px-8">
			...
			<p className="mb-2 text-base text-zinc-700">
				We've sent a verification link to your email address. <br /> Please click the link to activate your account.
			</p>
			<p className="mb-8 text-base font-bold text-red-600">The link will expire in 15 minutes.</p>
