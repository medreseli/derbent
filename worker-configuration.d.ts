/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d60ad1b82f72d9c2826ceb4b6e73d997)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "LOG_LEVEL" | "APP_NAME" | "COOKIE_DOMAIN" | "BASE_URL" | "PBKDF2_ITERATIONS" | "AUDIT_LOG_RETENTION_DAYS" | "RESEND_API_KEY" | "RESEND_DOMAIN" | "DERBENT_API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
declare module "*.svg" {
	const value: string;
