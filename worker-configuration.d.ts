/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a27a381228b4a466c960a99e6aad5a34)
// Runtime types generated with workerd@1.20260421.1 2026-02-25 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		BASE_URL: string;
		USE_DYNAMIC_CONFIG: string;
		PBKDF2_ITERATIONS: string;
		AUDIT_LOG_RETENTION_DAYS: string;
		DERBENT_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "LOG_LEVEL" | "APP_NAME" | "COOKIE_DOMAIN" | "BASE_URL" | "USE_DYNAMIC_CONFIG" | "PBKDF2_ITERATIONS" | "AUDIT_LOG_RETENTION_DAYS" | "DERBENT_API_KEY" | "RESEND_API_KEY" | "RESEND_DOMAIN" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
declare module "*.svg" {
	const value: string;
